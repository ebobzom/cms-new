...
export default [
    ...
    check('sectionId').exists().withMessage('section id field must not be empty'),
    check('sectionId').isLength({ min: 1, max: 3}).withMessage('categort id must be more than 2 letters and less than 11 letters')
]